...
sealed class Screen : Parcelable {
    @Parcelize
    data class AddEditNoteScreen(val noteGroup: NoteGroup? = null) : Screen()

    @Parcelize
    data class GroupNotesScreen(val groupUuid: Long) : Screen()
...
@Composable
inline fun <reified C : Parcelable> MyChildStack(
